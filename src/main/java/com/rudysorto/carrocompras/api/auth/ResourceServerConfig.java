...
Objective: class that is responsible for giving clients access to the resources of our application, as long as they have a valid token
*/
@Configuration
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/orders", "/api/orders/page/**", "/swagger-ui/**", "/v3/**" ).permitAll()
